...
@WebMvcTest(controllers = {HomeRestController.class, VehicleRestController.class, RentalBookingRestController.class})
class RestControllersTest {
    ...
    void testGetAllVehiclesWithFilters() throws Exception {
        Page<VehicleResponseDTO> page = new PageImpl<>(Arrays.asList(vehicleDTO));
        when(vehicleService.getAllVehicles(eq("SUV"), eq("Toyota"), any(Pageable.class))).thenReturn(page);
    ...
    void testSearchVehiclesAPI() throws Exception {
        ...
        when(bookingService.findAvailableVehicles(any(CreateRentalBookingRequestDTO.class)))
    ...
    void testGetBookingByIdAPI() throws Exception {
        ...
        mockMvc.perform(get("/api/bookings/VR000001"))
                .andExpect(status().isOk())
    ...
    void testApiCancelBookingSuccess() throws Exception {
        ...
        mockMvc.perform(delete("/api/bookings/VR000001/delete")
